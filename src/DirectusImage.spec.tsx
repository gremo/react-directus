...
describe('Component', () => {
  it.each([
    [{ apiUrl: 'http://example.com', asset: '11263b49-13b9-4ed8-ba39-01fe7cbeb284', width: 640, height: 480 }],
    [{ apiUrl: 'http://example.com', asset: { id: '1b86a776-34e5-4297-b8c5-58a85f15abe2' }, quality: 75 }],
    [{ apiUrl: 'http://example.com', asset: '11263b49-13b9-4ed8-ba39-01fe7cbeb284', fit: 'cover' }],
  ...
  it('build and pass the url to the renderer', () => {
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    render(<DirectusImage
      apiUrl="http://example.com"
      asset="8ac24997-cda5-4675-a1e0-1af72fddd220"
      width={640} height={480} quality={75} fit="outside"
